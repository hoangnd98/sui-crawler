...
- Transaction hydration still runs through archive gRPC `BatchGetTransactions` after digest discovery completes, chunked to 20 digests per RPC to stay under archive request-size limits.
